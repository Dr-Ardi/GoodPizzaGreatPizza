...
public class OrderController {
    ...
    @DeleteMapping(path = "/delete/{table_Number}")
    public void deleteTableOrder(@PathVariable("table_Number") Long table_Number){
        orderService.deleteTableOrder(table_Number);
    }
}
