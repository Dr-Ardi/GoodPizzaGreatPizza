...
INSERT INTO orders (table_number, priority, item_name, extra, excluded, quantity, ordered, order_cost, included, size, id) VALUES
(1, 1, 'Amstel Free', '', '', 2, 't', 10.6, '', '500ml', 41),
(1, 2, 'Cretan Salad', 'Tomatoes, ', '', 1, 't', 5.7, '', 'Medium (33cm)', 39),
(1, 3, 'French Fries', '', 'ketchup, ', 1, 't', 2.7, '', 'Medium (70gr)', 38),
(1, 4, 'Classic Pizza', 'mozzarella, ', 'pepperoni, bacon, 0.8, ', 2, 't', 23, '0.8, 0.5, 0.65, ketchup, lettuce, ', 'Medium (33cm)', 37),
(1, 4, 'Cheese Burger', 'Tomato, ', '0.5, 0.65, ketchup, lettuce, ', 1, 't', 10.45, '', 'Large (180gr)', 40);
...
(1, FALSE, FALSE, 'Cash', TRUE),
(2, FALSE, FALSE, 'Cash', FALSE),
(15, FALSE, TRUE, 'Cash', FALSE),
(4, FALSE, FALSE, 'Cash', FALSE),
(6, FALSE, FALSE, 'Cash', TRUE),
(3, FALSE, FALSE, 'Cash', FALSE);

INSERT INTO addables (item_type, sizable, meats, cheeses, sauces, extras, removables) VALUES
('Burger', TRUE, FALSE, TRUE, TRUE, TRUE, TRUE),
('Pasta', FALSE, FALSE, FALSE, FALSE, FALSE, FALSE),
('Appetiser', FALSE, FALSE, FALSE, TRUE, FALSE, FALSE),
('Fries', TRUE, FALSE, FALSE, TRUE, FALSE, FALSE),
('Water', TRUE, FALSE, FALSE, FALSE, FALSE, FALSE),
('Wine', TRUE, FALSE, FALSE, FALSE, FALSE, FALSE),
('Soft Drink', TRUE, FALSE, FALSE, FALSE, FALSE, FALSE),
('Salad', FALSE, FALSE, FALSE, FALSE, FALSE, TRUE),
('Beer', TRUE, FALSE, FALSE, FALSE, FALSE, FALSE),
('Pizza', TRUE, TRUE, TRUE, TRUE, TRUE, TRUE),
('Burger', TRUE, FALSE, TRUE, TRUE, TRUE, TRUE),
('Pasta', FALSE, FALSE, FALSE, FALSE, FALSE, FALSE),
('Appetiser', FALSE, FALSE, FALSE, TRUE, FALSE, FALSE),
('Fries', TRUE, FALSE, FALSE, TRUE, FALSE, FALSE),
